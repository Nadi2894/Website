      ...
      <Container id="cont2">
        <Row className="Row">
          <Col className="Col">
            ...
            and, if needed, have someone on-site at your facility within 24
            hours — guaranteed.
          </Col>
          <Col className="Col">
            ...
            complimentary service if you’re not satisfied at any time
            thereafter. 60 days’ complimentary service by another provider if
